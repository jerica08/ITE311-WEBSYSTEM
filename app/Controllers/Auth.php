        ...
        if ($this->request->getMethod() === 'post') {
            ...
            if ($this->validate($rules)) {
                ...
                try {
                    ...
                    log_message('info', 'Register insert result ID: {id}', ['id' => $insertId]);
                ...
                log_message('error', 'Register validation failed: {errors}', ['errors' => json_encode($this->validator->getErrors())]);

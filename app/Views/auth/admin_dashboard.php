        ...
        <nav class="navigationbar">
            ...
            <nav class="btm-navbar" style="background-color:#DAA520;font-family: 'Times New Roman', serif;">
                <div class="container-fluid d-flex justify-content-between align-items-center">
                    <a class="navbar-brand text-white" href="#"><h4>Learning Management System - Admin</h4></a>
                    <ul class="nav d-flex align-items-center gap-3">
                        <li class="nav-item"><a class="nav-link text-white" href="<?= base_url('admin_dashboard') ?>"><button class="button-active"> Admin Dashboard</button></a></li>
                        <li class="nav-item">

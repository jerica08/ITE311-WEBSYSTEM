    ...
    <body>
        <header>
            <nav class="navigationbar">
               <nav class="text d-flex align-items-center" style="background-color:#000000;padding: 10px;">
                    <p><h2 style="color: white;text-align:left;margin-bottom:none;font-family: 'Times New Roman', serif;">Kawas National University</h4></p>
                </nav>  
        ...
        <main class="main-content">
            <div class="container" style="text-align:center; margin-top: 50px;">
              <h1 style="font-weight:1000; font-family: 'Times New Roman', serif;">Kawas National Univerity</h1>
            </div>
        </main>
    </body>
</html>
